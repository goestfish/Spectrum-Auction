...
class MyAgent3(MyLSVMAgent):
    ...
    def teardown(self):
        ...
        for g, p in final_prices.items():
            MyAgent3.PRICE_HISTORY[g].append(float(p))
        MyAgent3.GAMES_PLAYED += 1


################### SUBMISSION #####################
my_agent_submission = MyAgent3(NAME)
####################################################
